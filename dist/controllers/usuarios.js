...
exports.deleteUsuario = exports.putUsuario = exports.postUsuario = exports.getUsuario = exports.getUsuariosActivos = exports.getUsuarios = void 0;
...
const putUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!usuario) {
            return res.status(404).json({
                msg: 'No existe un usuario con el email: ' + id
            });
        }
